...
public interface IndividualType {
	...
	/**
	 * @return a set of concepts occurring in the type
	 */
	public Set<OWLClass> getConcepts();

	/**
	 * @return a set of successor roles occurring in the type
	 */
	public Set<OWLObjectProperty> getSuccessorRoles();

	/**
	 * @return a set of predecessor roles occurring in the type
	 */
